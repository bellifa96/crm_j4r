...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\Entite\\DepotType' => ['privates', 'App\\Form\\Entite\\DepotType', 'getDepotTypeService', true],
            'App\\Form\\Entite\\EntiteType' => ['privates', 'App\\Form\\Entite\\EntiteType', 'getEntiteTypeService', true],
            'App\\Form\\Entite\\SousEntiteType' => ['privates', 'App\\Form\\Entite\\SousEntiteType', 'getSousEntiteTypeService', true],
            'App\\Form\\Ged\\FichierType' => ['privates', 'App\\Form\\Ged\\FichierType', 'getFichierTypeService', true],
            'App\\Form\\Ged\\TypeFichierType' => ['privates', 'App\\Form\\Ged\\TypeFichierType', 'getTypeFichierTypeService', true],
            'App\\Form\\Interlocuteur\\InterlocuteurType' => ['privates', 'App\\Form\\Interlocuteur\\InterlocuteurType', 'getInterlocuteurTypeService', true],
            'App\\Form\\Interlocuteur\\PersonneType' => ['privates', 'App\\Form\\Interlocuteur\\PersonneType', 'getPersonneTypeService', true],
            'App\\Form\\Interlocuteur\\SocieteType' => ['privates', 'App\\Form\\Interlocuteur\\SocieteType', 'getSocieteTypeService', true],
            'App\\Form\\UserType' => ['privates', 'App\\Form\\UserType', 'getUserTypeService', true],
            'App\\Form\\User\\PosteType' => ['privates', 'App\\Form\\User\\PosteType', 'getPosteTypeService', true],
            'App\\Form\\User\\ServiceType' => ['privates', 'App\\Form\\User\\ServiceType', 'getServiceTypeService', true],
            ...
            'App\\Form\\Entite\\DepotType' => '?',
            'App\\Form\\Entite\\EntiteType' => '?',
            'App\\Form\\Entite\\SousEntiteType' => '?',
            'App\\Form\\Ged\\FichierType' => '?',
            'App\\Form\\Ged\\TypeFichierType' => '?',
            'App\\Form\\Interlocuteur\\InterlocuteurType' => '?',
            'App\\Form\\Interlocuteur\\PersonneType' => '?',
            'App\\Form\\Interlocuteur\\SocieteType' => '?',
            'App\\Form\\UserType' => '?',
            'App\\Form\\User\\PosteType' => '?',
            'App\\Form\\User\\ServiceType' => '?',

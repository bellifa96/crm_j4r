...
#[ORM\Entity(repositoryClass: SousLotRepository::class)]
#[Gedmo\Loggable]
class SousLot
{
    use TimesTrait;
    ...
    #[ORM\ManyToOne(targetEntity: Lot::class, inversedBy: 'sousLots')]
